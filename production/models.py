...
class Bundle_Finished_Operations(models.Model):
    ...
    # not sure if this is necessary since we can trace Bundle -> Work Order ->
    # Order -> Style and Operations -> Style
...
# assign deliverable to production_line
class Production_Line_Deliverable(models.Model):
    production_line = models.ForeignKey(Production_Line, on_delete=None)
